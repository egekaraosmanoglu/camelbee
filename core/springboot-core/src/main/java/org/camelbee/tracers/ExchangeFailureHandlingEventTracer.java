...
public class ExchangeFailureHandlingEventTracer extends CamelEventTracer {
  ...
  public void trace(Exchange exchange, Processor failureHandler, MessageService messageService) {
    ...
    try {
      ...
      if (exceptionHandlerRouteId != null) {
        handlerRouteEndpoint = ((ModelCamelContext) exchange.getContext()).getRouteDefinition(exceptionHandlerRouteId).getEndpointUrl();
      ...
      InterceptorType interceptorType = (InterceptorType) exchange.getProperty(CamelBeeConstants.CURRENT_INTERCEPTOR_TYPE);
  ...
  private void handleEndpointResponse(Exchange exchange, MessageService messageService, String httpResponseBody, Deque<String> clonedStack,
      String handlerRouteEndpoint) {
  ...
  private void handleDirectResponse(Exchange exchange, MessageService messageService, String httpResponseBody, Deque<String> clonedStack, String callerRoute,
      String handlerRouteEndpoint) {
